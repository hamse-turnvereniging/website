...
<template>
  <section id="banner" class="shadow-lg">
    <div class="flex flex-col max-w-6xl mx-auto px-6 py-[115px]">
  ...
  <section id="turnen" class="relative">
    <div class="circle circle-grey w-[1200px] -top-[200px] -left-[200px]" />
    <div class="flex flex-col max-w-6xl px-6 py-16 mx-auto gap-12">
  ...
  <section id="trampoline" class="relative">
    <div class="circle circle-primary w-[800px] -top-[200px] -right-[200px]" />
    <div class="flex flex-col max-w-6xl px-6 py-16 mx-auto gap-12">
      <div class="flex flex-row items-center gap-12">
        <div class="flex flex-col gap-6">
          ...
          <p>
            Bij ons kunnen kinderen vanaf het 1ste leerjaar starten met trampolinespringen. We
            bouwen rustig op, met aandacht voor een goede lichaamshouding, sprongcontrole en vooral
            veiligheid. Iedereen werkt op zijn of haar eigen tempo en niveau, onder begeleiding van
            enthousiaste en ervaren trainers.
          </p>
          <p>
  ...
  <section id="bbb" class="relative">
    <div class="circle circle-grey w-[800px] -top-[200px] -left-[200px]" />
    <div class="flex flex-col max-w-6xl px-6 py-16 mx-auto gap-12">
      <div class="flex flex-row items-center gap-12">
        <img class="flex-none shadow-lg" src="https://placehold.co/600x400" />
        <div class="flex flex-col gap-6">
          ...
          <p>
            BBB staat voor Benen, Billen en Buik - een leuke en effectieve groepsles die focust op
          ...
          <p>
            De lessen zijn laagdrempelig en geschikt voor alle leeftijden en niveaus. Of je nu net
  ...
  <section id="callanetics" class="relative">
    <div class="flex flex-col max-w-6xl px-6 py-16 mx-auto gap-12">
      <div class="flex flex-row items-center gap-12">
        <div class="flex flex-col gap-6">
          ...
          <p>
            ...
            werk je aan kracht, lenigheid en een betere lichaamshouding - zonder schokken of impact
            op je gewrichten.
          </p>
          <p>
            Deze trainingsmethode is ideaal voor wie op een veilige en doeltreffende manier aan zijn
            lichaam wil werken. De oefeningen lijken misschien eenvoudig, maar ze zijn bijzonder
            effectief - al na een paar lessen merk je verschil in spierspanning en soepelheid.
          </p>
          <p>
            Callanetics is geschikt voor alle leeftijden, ook voor mensen met rug- of
    ...
    <div class="circle circle-grey w-[1200px] -top-[200px] -right-[200px]" />
  </section>
  <section id="net-voetbal-heren" class="relative">
    <div class="circle circle-primary w-[800px] -bottom-[200px] -left-[200px]" />
    <div class="flex flex-col max-w-6xl px-6 py-16 mx-auto gap-12">
      <div class="flex flex-row items-center gap-12">
        <img class="flex-none shadow-lg" src="https://placehold.co/600x400" />
        <div class="flex flex-col gap-6">
          ...
          <p>
            ...
            met maximum drie contacten terug over het net te spelen - zonder handen, dus met de
            voeten, benen, hoofd of borst.
          </p>
          <p>
...
section#banner {
  height: 280px;
  background-image: url("https://placehold.co/1600x280");
